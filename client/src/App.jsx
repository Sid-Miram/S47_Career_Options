...
//           if (typeof a[sortCriteria] === "undefined" || typeof b[sortCriteria] === "undefined") {
//             // Handle case where sortBy property is undefined
...
//             </ul>
//             {entity.createdBy && <p> createdBy {entity.createdBy} </p>}
...
function App() {
  ...
  const [user, setUser] = useState(null);
  const [sortCriteria, setSortCriteria] = useState('day'); // State for sorting criteria
  const [filterCreatedBy, setFilterCreatedBy] = useState(""); // State for filtering by createdBy
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [sortCriteria, filterCreatedBy]); // Re-fetch data when sort criteria or filterCreatedBy changes
  ...
  return (
    <div className="App">
      ...
      <div className="entity-container">
    {data
      .filter(entity => !filterCreatedBy || (entity.createdBy && entity.createdBy.toLowerCase().includes(filterCreatedBy.toLowerCase())))
      .map((entity, index) => (
        <div className="entity" key={index}>
          <h2>Day {entity.day}: {entity.title}</h2>
          <ul>
